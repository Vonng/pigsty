...
resource "alicloud_instance" "pg-el8" {
  ...
  image_id                   = "rockylinux_8_9_x64_20G_alibase_20231221.vhd"
...
resource "alicloud_instance" "pg-el9" {
  ...
  vswitch_id                 = "${alicloud_vswitch.vsw.id}"
  security_groups            = ["${alicloud_security_group.default.id}"]
  image_id                   = "rockylinux_9_3_x64_20G_alibase_20231221.vhd"
  password                   = "PigstyDemo4"
...
resource "alicloud_instance" "pg-d12" {
  ...
  vswitch_id                 = "${alicloud_vswitch.vsw.id}"
  security_groups            = ["${alicloud_security_group.default.id}"]
  image_id                   = "debian_12_4_x64_20G_alibase_20231220.vhd"
  password                   = "PigstyDemo4"
