...
(118, 'repo_url_packages', '["http://download.pigsty.cc/rpm/pev.html", "http://download.pigsty.cc/rpm/chart.tgz"]', 'INFRA', 'REPO', 'string[]', 'G', 'extra packages from url', NULL),
