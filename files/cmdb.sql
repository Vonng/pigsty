...
-- INFRA PARAMETERS
(101, 'version', '"v3.0.2"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(119, 'repo_url_packages', '[{"name": "pev.html", "url": "https://repo.pigsty.io/etc/pev-1.12.1.html"}, {"name": "chart.tgz", "url": "https://repo.pigsty.io/etc/chart-1.0.0.tgz"}, {"name": "plugins.tgz", "url": "https://repo.pigsty.io/etc/plugins-11.2.0.tgz"}]', 'INFRA', 'REPO', 'string[]', 'G', 'extra packages from url', NULL),
...
(848, 'pg_packages', '["postgresql", "patroni pgbouncer pgbackrest pg_exporter pgbadger vip-manager wal2json pg_repack"]', 'PGSQL', 'PG_INSTALL', 'string[]', 'C', 'pg packages to be installed, `${pg_version}` will be replaced', NULL),
(849, 'pg_extensions', '["postgis timescaledb pgvector"]', 'PGSQL', 'PG_INSTALL', 'string[]', 'C', 'pg extensions to be installed, `${pg_version}` will be replaced', NULL),
