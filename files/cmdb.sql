...
-- INFRA PARAMETERS
(101, 'version', '"v2.1.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(115, 'repo_modules', '"node,infra,pgsql,redis"', 'INFRA', 'REPO', 'string', 'G/A', 'which repo modules are installed in repo_upstream', NULL),
...
(117, 'repo_packages', '["grafana loki logcli promtail", "prometheus2 alertmanager pushgateway blackbox_exporter node_exporter redis_exporter", "nginx nginx_exporter wget createrepo_c sshpass mtail dnsmasq docker-ce docker-compose-plugin etcd", "ansible python3.11-jmespath python3 python3-pip python3-requests", "lz4 unzip bzip2 zlib yum dnf-utils pv jq git ncdu make patch bash lsof wget uuid tuned chrony perf flamegraph nvme-cli numactl grubby sysstat iotop htop modulemd-tools", "netcat socat rsync ftp lrzsz s3cmd net-tools tcpdump ipvsadm bind-utils telnet audit ca-certificates openssl openssh-clients readline vim-minimal haproxy redis", "postgresql15* citus_15* pglogical_15* wal2json_15* pg_repack_15* pgvector_15* timescaledb-2-postgresql-15* postgis33_15* timescaledb-tools passwordcheck_cracklib_15* pg_cron_15*", "postgresql14* citus_14* pglogical_14* wal2json_14* pg_repack_14* pgvector_14* timescaledb-2-postgresql-14* postgis33_14 postgis33_14-devel postgis33_14-utils passwordcheck_cracklib_14* pg_cron_14*", "postgresql13* citus_13* pglogical_13* wal2json_13* pg_repack_13* pgvector_13* timescaledb-2-postgresql-13* postgis33_13 postgis33_13-devel postgis33_13-utils passwordcheck_cracklib_13* pg_cron_13*", "postgresql12* citus_12* pglogical_12* wal2json_12* pg_repack_12* pgvector_12* timescaledb-2-postgresql-12* postgis33_12 postgis33_12-devel postgis33_12-utils passwordcheck_cracklib_12* pg_cron_12*", "postgresql16*", "patroni patroni-etcd pgbouncer pgbadger pgbackrest tail_n_mail pgloader pg_activity libuser openldap-compat annobin gcc-plugin-annobin", "orafce_15* mysqlcompat_15 mongo_fdw_15* tds_fdw_15* mysql_fdw_15 hdfs_fdw_15 sqlite_fdw_15 pgbouncer_fdw_15 multicorn2_15* sequential_uuids_15", "powa_15* pg_stat_kcache_15* pg_stat_monitor_15* pg_qualstats_15 pg_track_settings_15 pg_wait_sampling_15 system_stats_15 logerrors_15 pg_top_15", "plprofiler_15* plproxy_15 plsh_15* pldebugger_15 plpgsql_check_15*  pgtt_15 pgq_15* pgsql_tweaks_15 count_distinct_15 hypopg_15", "timestamp9_15* semver_15* prefix_15* rum_15 geoip_15 periods_15 ip4r_15 tdigest_15 hll_15 pgmp_15 extra_window_functions_15 topn_15", "pg_comparator_15 pg_ivm_15* pgsodium_15* pgfincore_15* ddlx_15 credcheck_15 safeupdate_15 pg_squeeze_15* passwordcheck_cracklib_15", "pg_fkpart_15 pg_jobmon_15 pg_partman_15 pg_permissions_15 pgaudit17_15 pgexportdoc_15 pgimportdoc_15 pg_statement_rollback_15*", "pg_background_15 e-maj_15 pg_catcheck_15 pg_prioritize_15 pgcopydb_15 pg_filedump_15 pgcryptokey_15"]', 'INFRA', 'REPO', 'string[]', 'G', 'which packages to be included', NULL),
(118, 'repo_url_packages', '["https://github.com/Vonng/pg_exporter/releases/download/v0.5.0/pg_exporter-0.5.0.x86_64.rpm", "https://github.com/cybertec-postgresql/vip-manager/releases/download/v2.1.0/vip-manager_2.1.0_Linux_x86_64.rpm", "https://github.com/dalibo/pev2/releases/download/v1.8.0/index.html", "https://dl.min.io/server/minio/release/linux-amd64/archive/minio-20230711212934.0.0.x86_64.rpm", "https://dl.min.io/client/mc/release/linux-amd64/archive/mcli-20230711233044.0.0.x86_64.rpm", "https://rpmfind.net/linux/remi/enterprise/9/modular/x86_64/redis-7.0.11-1.el9.remi.x86_64.rpm"]', 'INFRA', 'REPO', 'string[]', 'G', 'extra packages from url', NULL),

(120, 'infra_packages', '["grafana,loki,prometheus2,alertmanager,pushgateway,blackbox_exporter,nginx_exporter,redis_exporter,pg_exporter", "nginx,ansible,python3-requests,redis,mcli,logcli,postgresql15"]', 'INFRA', 'INFRA_PACKAGE', 'string[]', 'G', 'packages to be installed on infra nodes', NULL),
...
(131, 'nginx_sslmode', '"enable"', 'INFRA', 'NGINX', 'enum', 'G', 'nginx ssl mode? disable,enable,enforce', NULL),
(132, 'nginx_home', '"/www"', 'INFRA', 'NGINX', 'path', 'G', 'nginx content dir, `/www` by default', NULL),
(133, 'nginx_port', '80', 'INFRA', 'NGINX', 'port', 'G', 'nginx listen port, 80 by default', NULL),
(134, 'nginx_ssl_port', '443', 'INFRA', 'NGINX', 'port', 'G', 'nginx ssl listen port, 443 by default', NULL),
(135, 'nginx_navbar', '[{"url": "/ca.crt", "desc": "pigsty self-signed ca.crt", "name": "CA Cert"}, {"url": "/pigsty", "desc": "local yum repo packages", "name": "Package"}, {"url": "/pigsty/pev.html", "desc": "postgres explain visualizer", "name": "Explain"}, {"url": "/logs", "desc": "postgres raw csv logs", "name": "PG Logs"}, {"url": "/report", "desc": "pgbadger summary report", "name": "Reports"}]', 'INFRA', 'NGINX', 'index[]', 'G', 'nginx index page navigation links', NULL),
...
(153, 'prometheus_sd_interval', '"5s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus target refresh interval, 5s by default', NULL),
(154, 'prometheus_scrape_interval', '"10s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus scrape & eval interval, 10s by default', NULL),
(155, 'prometheus_scrape_timeout', '"8s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus global scrape timeout, 8s by default', NULL),
(156, 'prometheus_options', '"--storage.tsdb.retention.time=15d"', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'prometheus extra server options', NULL),
(157, 'pushgateway_enabled', 'true', 'INFRA', 'PROMETHEUS', 'bool', 'G/I', 'setup pushgateway on this infra node?', NULL),
(158, 'pushgateway_options', '"--persistence.interval=1m"', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'pushgateway extra server options', NULL),
(159, 'blackbox_enabled', 'true', 'INFRA', 'PROMETHEUS', 'bool', 'G/I', 'setup blackbox_exporter on this infra node?', NULL),
(160, 'blackbox_options', '""', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'blackbox_exporter extra server options', NULL),
(161, 'alertmanager_enabled', 'true', 'INFRA', 'PROMETHEUS', 'bool', 'G/I', 'setup alertmanager on this infra node?', NULL),
(162, 'alertmanager_options', '""', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'alertmanager extra server options', NULL),
(163, 'exporter_metrics_path', '"/metrics"', 'INFRA', 'PROMETHEUS', 'path', 'G', 'exporter metric path, `/metrics` by default', NULL),
(164, 'exporter_install', '"none"', 'INFRA', 'PROMETHEUS', 'enum', 'G', 'how to install exporter? none,yum,binary', NULL),
(165, 'exporter_repo_url', '""', 'INFRA', 'PROMETHEUS', 'url', 'G', 'exporter repo file url if install exporter via yum', NULL),
...
(224, 'node_default_packages', '["lz4,unzip,bzip2,zlib,yum,pv,jq,git,ncdu,make,patch,bash,lsof,wget,uuid,tuned,chrony,nvme-cli,numactl,grubby,sysstat,iotop,htop,yum,yum-utils", "wget,netcat,socat,rsync,ftp,lrzsz,s3cmd,net-tools,tcpdump,ipvsadm,bind-utils,telnet,dnsmasq,audit,ca-certificates,openssl,openssh-clients,readline,vim-minimal", "node_exporter,etcd,mtail,python3,python3-pip,python3-idna,python3-requests,haproxy"]', 'NODE', 'NODE_PACKAGE', 'string[]', 'G', 'default packages to be installed on all nodes', NULL),
...
(720, 'redis_safeguard', 'false', 'REDIS', 'REDIS', 'bool', 'C', 'prevent purging running redis instance?', NULL),
(721, 'redis_clean', 'true', 'REDIS', 'REDIS', 'bool', 'C', 'purging existing redis during init?', NULL),
(722, 'redis_rmdata', 'true', 'REDIS', 'REDIS', 'bool', 'A', 'remove redis data when purging redis server?', NULL),
...
(845, 'pg_version', '15', 'PGSQL', 'PG_INSTALL', 'enum', 'C', 'postgres major version to be installed, 15 by default', NULL),
...
(875, 'pg_libs', '"timescaledb, pg_stat_statements, auto_explain"', 'PGSQL', 'PG_BOOTSTRAP', 'string', 'C', 'preloaded libraries, `pg_stat_statements,auto_explain` by default', NULL),
