...
(532, 'pg_extensions', '["postgis33_${pg_version}* pg_repack_${pg_version} wal2json_${pg_version} timescaledb-2-postgresql-${pg_version} citus*${pg_version}*"]', 'PGSQL', 'PG_INSTALL', 'string[]', 'C', 'pg extensions to be installed, `${pg_version}` will be replaced', NULL),
