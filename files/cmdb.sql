...
(609, 'pg_default_service_dest', '"pgbouncer"', 'PGSQL', 'PG_PROVISION', 'enum', 'G/C', 'default service destination if svc.dest=''default''', NULL),
(610, 'pg_default_services', '[{"dest": "default", "name": "primary", "port": 5433, "check": "/primary", "selector": "[]"}, {"dest": "default", "name": "replica", "port": 5434, "check": "/read-only", "backup": "[? pg_role == `primary` || pg_role == `offline` ]", "selector": "[]"}, {"dest": "postgres", "name": "default", "port": 5436, "check": "/primary", "selector": "[]"}, {"dest": "postgres", "name": "offline", "port": 5438, "check": "/replica", "backup": "[? pg_role == `replica` && !pg_offline_query]", "selector": "[? pg_role == `offline` || pg_offline_query ]"}]', 'PGSQL', 'PG_PROVISION', 'service[]', 'G/C', 'postgres default service definitions', NULL),
