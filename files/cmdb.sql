...
(346, 'node_feature_kernel', 'NODES', 'NODE_MODULES', 'string[]', 'C', '启用的内核模块', 'kernel modules to be installed', '节点内核模块', '["softdog", "br_netfilter", "ip_vs", "ip_vs_rr", "ip_vs_rr", "ip_vs_wrr", "ip_vs_sh"]'),
(350, 'node_tune', 'NODES', 'NODE_TUNE', 'enum', 'C', '节点调优模式', 'node tune mode', '节点参数调优', '"tiny"'),
(351, 'node_tune_sysctl', 'NODES', 'NODE_TUNE', 'dict', 'C', '操作系统内核参数', 'extra kernel parameters', '节点参数调优', '{}'),
