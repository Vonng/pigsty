...
(120, 'infra_packages', '["grafana,loki,prometheus2,alertmanager,pushgateway,blackbox_exporter,nginx_exporter", "nginx,ansible,python3-requests,mcli,logcli"]', 'INFRA', 'INFRA_PACKAGE', 'string[]', 'G', 'packages to be installed on infra nodes', NULL),
