...
-- INFRA PARAMETERS
(101, 'version', '"v2.0.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(117, 'repo_url_packages', '["https://github.com/Vonng/pg_exporter/releases/download/v0.5.0/pg_exporter-0.5.0.x86_64.rpm", "https://github.com/cybertec-postgresql/vip-manager/releases/download/v2.1.0/vip-manager_2.1.0_Linux_x86_64.rpm", "https://github.com/dalibo/pev2/releases/download/v1.7.0/index.html", "https://dl.min.io/server/minio/release/linux-amd64/archive/minio-20230222182345.0.0.x86_64.rpm", "https://dl.min.io/client/mc/release/linux-amd64/archive/mcli-20230216192011.0.0.x86_64.rpm"]', 'INFRA', 'REPO', 'string[]', 'G', 'extra packages from url', NULL),
