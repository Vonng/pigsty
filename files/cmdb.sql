...
-- INFRA PARAMETERS
(101, 'version', '"v2.6.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(116, 'repo_upstream', '[{"name": "pigsty-local", "module": "local", "baseurl": {"default": "http://${admin_ip}/pigsty ./"}, "releases": [11, 12, 20, 22], "description": "Pigsty Local"}, {"name": "pigsty-pgsql", "module": "pgsql", "baseurl": {"china": "https://repo.pigsty.cc/deb/pgsql/${distro_codename}.amd64/ ./", "default": "https://repo.pigsty.io/deb/pgsql/${distro_codename}.amd64/ ./"}, "releases": [11, 12, 20, 22], "description": "Pigsty PgSQL"}, {"name": "pigsty-infra", "module": "infra", "baseurl": {"china": "https://repo.pigsty.cc/deb/infra/amd64/ ./", "default": "https://repo.pigsty.io/deb/infra/amd64/ ./"}, "releases": [11, 12, 20, 22], "description": "Pigsty Infra"}, {"name": "nginx", "module": "infra", "baseurl": {"default": "http://nginx.org/packages/mainline/${distro_name} ${distro_codename} nginx"}, "releases": [11, 12, 20, 22], "description": "Nginx"}, {"name": "base", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/debian/ ${distro_codename} main restricted universe multiverse", "default": "http://deb.debian.org/debian/ ${distro_codename} main non-free-firmware"}, "releases": [11, 12], "description": "Debian Basic"}, {"name": "updates", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/debian/ ${distro_codename}-updates main restricted universe multiverse", "default": "http://deb.debian.org/debian/ ${distro_codename}-updates main non-free-firmware"}, "releases": [11, 12], "description": "Debian Updates"}, {"name": "security", "module": "node", "baseurl": {"default": "http://security.debian.org/debian-security ${distro_codename}-security main non-free-firmware"}, "releases": [11, 12], "description": "Debian Security"}, {"name": "base", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/${distro_name}/ ${distro_codename}   main restricted universe multiverse", "default": "https://mirrors.edge.kernel.org/${distro_name}/ ${distro_codename}   main universe multiverse restricted"}, "releases": [20, 22], "description": "Ubuntu Basic"}, {"name": "updates", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/ubuntu/ ${distro_codename}-updates   main restricted universe multiverse", "default": "https://mirrors.edge.kernel.org/ubuntu/ ${distro_codename}-backports main restricted universe multiverse"}, "releases": [20, 22], "description": "Ubuntu Updates"}, {"name": "backports", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/ubuntu/ ${distro_codename}-backports main restricted universe multiverse", "default": "https://mirrors.edge.kernel.org/ubuntu/ ${distro_codename}-security  main restricted universe multiverse"}, "releases": [20, 22], "description": "Ubuntu Backports"}, {"name": "security", "module": "node", "baseurl": {"china": "https://mirrors.aliyun.com/ubuntu/ ${distro_codename}-security  main restricted universe multiverse", "default": "https://mirrors.edge.kernel.org/ubuntu/ ${distro_codename}-updates   main restricted universe multiverse"}, "releases": [20, 22], "description": "Ubuntu Security"}, {"name": "pgdg", "module": "pgsql", "baseurl": {"china": "https://mirrors.tuna.tsinghua.edu.cn/postgresql/repos/apt/ ${distro_codename}-pgdg main", "default": "http://apt.postgresql.org/pub/repos/apt/ ${distro_codename}-pgdg main"}, "releases": [11, 12, 20, 22], "description": "PGDG"}, {"name": "citus", "module": "pgsql", "baseurl": {"default": "https://packagecloud.io/citusdata/community/${distro_name}/ ${distro_codename} main"}, "releases": [11, 12, 20, 22], "description": "Citus"}, {"name": "timescaledb", "module": "pgsql", "baseurl": {"default": "https://packagecloud.io/timescale/timescaledb/${distro_name}/ ${distro_codename} main"}, "releases": [11, 12, 20, 22], "description": "Timescaledb"}, {"name": "redis", "module": "redis", "baseurl": {"default": "https://packages.redis.io/deb ${distro_codename} main"}, "releases": [11, 12, 20, 22], "description": "Redis"}, {"name": "docker-ce", "module": "infra", "baseurl": {"china": "https://mirrors.tuna.tsinghua.edu.cn/docker-ce/linux//${distro_name} ${distro_codename} stable", "default": "https://download.docker.com/linux/${distro_name} ${distro_codename} stable"}, "releases": [11, 12, 20, 22], "description": "Docker"}]', 'INFRA', 'REPO', 'upstream[]', 'G', 'where to download upstream packages', NULL),
(117, 'repo_packages', '["ansible python3 python3-pip python3-virtualenv python3-requests python3-jmespath python3.11-jmespath python3.11-pip dnf-utils modulemd-tools createrepo_c sshpass", "nginx dnsmasq etcd haproxy vip-manager pg_exporter pgbackrest_exporter", "grafana loki logcli promtail prometheus2 alertmanager pushgateway node_exporter blackbox_exporter nginx_exporter keepalived_exporter", "rlz4 unzip bzip2 zlib yum pv jq git ncdu make patch bash lsof wget uuid tuned nvme-cli numactl grubby sysstat iotop htop rsync tcpdump perf flamegraph", "netcat socat ftp lrzsz net-tools ipvsadm bind-utils telnet audit ca-certificates openssl openssh-clients readline vim-minimal keepalived chrony", "patroni patroni-etcd pgbouncer pgbadger pgbackrest pgloader pg_activity pg_filedump timescaledb-tools scws libduckdb pgFormatter", "postgresql16* pg_repack_16* wal2json_16* passwordcheck_cracklib_16* pglogical_16* pg_cron_16* postgis34_16* timescaledb-2-postgresql-16* pgvector_16* citus_16*", "pgml_16* pg_graphql_16 pg_net_16* pgsql-http_16* pgsql-gzip_16* vault_16 pgjwt_16 pg_tle_16* pg_roaringbitmap_16* pointcloud_16* zhparser_16* hydra_16* apache-age_16* duckdb_fdw_16* pg_sparse_16* pg_sparse_16* pg_bm25_16* pg_analytics_16*", "orafce_16* mongo_fdw_16* tds_fdw_16* mysql_fdw_16 hdfs_fdw_16 sqlite_fdw_16 pgbouncer_fdw_16 powa_16* pg_stat_kcache_16* pg_stat_monitor_16* pg_qualstats_16 pg_track_settings_16 pg_wait_sampling_16 hll_16 pgaudit_16", "plprofiler_16* plsh_16* pldebugger_16 plpgsql_check_16* pgtt_16 pgq_16* pgsql_tweaks_16 count_distinct_16 hypopg_16 timestamp9_16* semver_16* prefix_16* periods_16 ip4r_16 tdigest_16 pgmp_16 extra_window_functions_16 topn_16", "pg_background_16 e-maj_16 pg_prioritize_16 pgcryptokey_16 logerrors_16 pg_top_16 pg_comparator_16 pg_ivm_16* pgsodium_16* pgfincore_16* ddlx_16 credcheck_16 safeupdate_16 pg_squeeze_16* pg_fkpart_16 pg_jobmon_16", "pg_partman_16 pg_permissions_16 pgexportdoc_16 pgimportdoc_16 pg_statement_rollback_16* pg_hint_plan_16* pg_auth_mon_16 pg_checksums_16 pg_failover_slots_16 pg_readonly_16* pg_uuidv7_16* set_user_16* rum_16", "redis_exporter mysqld_exporter mongodb_exporter docker-ce docker-compose-plugin redis minio mcli ferretdb duckdb sealos"]', 'INFRA', 'REPO', 'string[]', 'G', 'which packages to be included', NULL),
