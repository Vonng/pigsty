...
(120, 'infra_packages', '["grafana,loki,logcli,promtail,prometheus2,alertmanager,karma,pushgateway", "node_exporter,blackbox_exporter,nginx_exporter,redis_exporter,pg_exporter", "nginx,dnsmasq,ansible,postgresql15,redis,mcli,etcd,python3-requests"]', 'INFRA', 'INFRA_PACKAGE', 'string[]', 'G', 'packages to be installed on infra nodes', NULL),
...
(848, 'pg_packages', '["postgresql${pg_version}*", "patroni pgbouncer pgbackrest pg_exporter pgbadger patroni-etcd vip-manager"]', 'PGSQL', 'PG_INSTALL', 'string[]', 'C', 'pg packages to be installed, `${pg_version}` will be replaced', NULL),
