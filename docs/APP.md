...
There are lots of softwares using PostgreSQL. Pigsty has some docker compose template for some popular softwares.

You can launch stateless software with docker easily and using external HA PostgreSQL for higher availbility & durability.
