...
```yaml
    version: v2.0.1                   # pigsty version string
...
repo_url_packages:                # extra packages from url
  ...
  - https://dl.min.io/server/minio/release/linux-amd64/archive/minio-20230222182345.0.0.x86_64.rpm
  - https://dl.min.io/client/mc/release/linux-amd64/archive/mcli-20230216192011.0.0.x86_64.rpm
```
