...
```bash
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-v2.4.0.tgz                   # source code
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el7.x86_64.tgz    # el7 packages
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el8.x86_64.tgz    # el8 packages
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el9.x86_64.tgz    # el9 packages
```

For mainland China users, you can download these packages from the following mirror:

```bash
https://get.pigsty.cc/v2.4.0/pigsty-v2.4.0.tgz                   # source code
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el7.x86_64.tgz    # el7 packages
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el8.x86_64.tgz    # el8 packages
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el9.x86_64.tgz    # el9 packages
```
