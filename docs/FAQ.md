...
```bash
https://github.com/Vonng/pigsty/releases/download/v2.2.1/pigsty-v2.2.1.tgz                   # source code
https://github.com/Vonng/pigsty/releases/download/v2.2.1/pigsty-pkg-v2.2.1.el7.x86_64.tgz    # el7 packages
https://github.com/Vonng/pigsty/releases/download/v2.2.1/pigsty-pkg-v2.2.1.el8.x86_64.tgz    # el8 packages
https://github.com/Vonng/pigsty/releases/download/v2.2.1/pigsty-pkg-v2.2.1.el9.x86_64.tgz    # el9 packages
```
