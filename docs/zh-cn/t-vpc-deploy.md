...
本文将介绍如何使用腾讯云虚拟机[部署](d-deploy.md)Pigsty。
...
如果您不能访问Github（在大陆是很常见的），也可以从别的地方[下载](d-prepare.md#pigsty源代码)（例如百度云盘），然后手工拷贝至服务器上：
...
configure pigsty 1.4.0-rc begin
[ OK ] kernel = Linux
[ OK ] machine = x86_64
...
则还需要调整 [nginx_upstream](v-infra.md#nginx_upstream) 中的域名
