...
> Latest Version: [v2.0.0-rc1](https://github.com/Vonng/pigsty/releases/tag/v2.0.0-rc1)  |  [Github Repo](https://github.com/Vonng/pigsty) | [Demo](http://demo.pigsty.cc) | [Github Pages](https://vonng.github.io/pigsty/#/) | [Website](https://pigsty.cc/en/)
...
>  `getb` will get the latest beta, v2.0.0-rc1, while `get` will use the last stable release, v1.5.1. 
...
git clone https://github.com/Vonng/pigsty; cd pigsty; git checkout v2.0.0-rc1
```
