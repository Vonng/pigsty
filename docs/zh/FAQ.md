...
```bash
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-v2.4.0.tgz                   # 源代码包
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el7.x86_64.tgz    # el7离线包
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el8.x86_64.tgz    # el8离线包
https://github.com/Vonng/pigsty/releases/download/v2.4.0/pigsty-pkg-v2.4.0.el9.x86_64.tgz    # el9离线包
```

中国大陆用户可以考虑使用 CDN 下载：

```bash
https://get.pigsty.cc/v2.4.0/pigsty-v2.4.0.tgz                   # 源代码
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el7.x86_64.tgz    # el7离线包
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el8.x86_64.tgz    # el8离线包
https://get.pigsty.cc/v2.4.0/pigsty-pkg-v2.4.0.el9.x86_64.tgz    # el9离线包
```
