...
curl -L https://github.com/Vonng/pigsty/releases/download/v2.5.1/pigsty-v2.5.1.tgz -o ~/pigsty.tgz                 # SRC
curl -L https://github.com/Vonng/pigsty/releases/download/v2.5.1/pigsty-pkg-v2.5.1.el9.x86_64.tgz -o /tmp/pkg.tgz  # EL9
curl -L https://github.com/Vonng/pigsty/releases/download/v2.5.1/pigsty-pkg-v2.5.1.el8.x86_64.tgz -o /tmp/pkg.tgz  # EL8
curl -L https://github.com/Vonng/pigsty/releases/download/v2.5.1/pigsty-pkg-v2.5.1.el7.x86_64.tgz -o /tmp/pkg.tgz  # EL7
```
...
We recommend using **RockyLinux 8.9, 9.3** and **Ubuntu 22.04** (jammy) as the underlying Operating System, we have pre-packed [offline packages](docs/INSTALL#offline-packages) for these three distributions.
...
If you have advanced compatibility requirements, such as using a specific OS distribution, supporting a specific version of PostgreSQL, or need consulting & support, we also provide [commercial support](docs/SUPPORT.md) options.
