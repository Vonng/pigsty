...
> Latest Version: [1.5.0-beta](https://github.com/Vonng/pigsty/releases/tag/v1.5.0-rc)  |  [Demo](http://demo.pigsty.cc)
>
...
curl -SL https://github.com/Vonng/pigsty/releases/download/v1.5.0-rc/pkg.tgz -o /tmp/pkg.tgz # optional
```
