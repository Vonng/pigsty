...
Note that provisioning resources (dashboards) are under pigsty home dir files/dashboards
...
```yaml
Make sure grafana installed	TAGS: [grafana, grafana_install, infra]
Stop grafana service	TAGS: [grafana, grafana_stop, infra]
Check grafana plugin cache exists	TAGS: [grafana, grafana_plugins, infra]
Provision grafana plugins via cache if exists	TAGS: [grafana, grafana_plugins, grafana_plugins_unzip, infra]
Download grafana plugins via internet	TAGS: [grafana, grafana_plugins, infra]
Download grafana plugins via git	TAGS: [grafana, grafana_plugins, infra]
Remove grafana provisioning config	TAGS: [grafana, grafana_config, infra]
Remake grafana resource dir	TAGS: [grafana, grafana_config, infra]
Templating /etc/grafana/grafana.ini	TAGS: [grafana, grafana_config, infra]
Templating datasources provisioning config	TAGS: [grafana, grafana_config, infra]
Templating dashboards provisioning config	TAGS: [grafana, grafana_config, infra]
Launch grafana service	TAGS: [grafana, grafana_launch, infra]
Wait for grafana online	TAGS: [grafana, grafana_launch, infra]
Sync grafana home and core dashboards	TAGS: [dashboard, dashboard_sync, grafana, grafana_provision, infra]
Provisioning grafana with grafana.py	TAGS: [dashboard, dashboard_init, grafana, grafana_provision, infra]
Register consul grafana service	TAGS: [grafana, grafana_register, infra]
Reload consul	TAGS: [grafana, grafana_register, infra]
```
