...
# License   :   AGPLv3
#==============================================================#
DEFAULT_VERSION=v3.0.0-a1
DEFAULT_REGION=global

# To install the latest version of pigsty (v3.0.0-a1):
# curl -fsSL https://repo.pigsty.io/get | bash

# To install a specific version of pigsty (e.g. v2.7.0)
...
v2.5.1 v2.6.0 v2.7.0 v3.0.0-a1 v3.0.0"
